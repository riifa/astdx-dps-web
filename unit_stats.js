...
const characterData = {
    ...
    "Magma Marine": {
        ...
        Stats: {
            Damage: [
                "270", "565", "885", "3400", "4520", "5680", "4390", "5280", "5480"
            ],
            Range: [
    ...
    "Spider Boss": {
        ...
        Stats: {
            Damage: [
                "180", "950", "1430", "1960", "2550", "3250", "5100", "7220", "10295"
            ],
            Range: [
    ...
    "Alligator": {
        ...
        Stats: {
            Damage: [
                "470", "890", "1345", "5175", "7135", "9135", "7005", "8640"
            ],
            Range: [
    ...
    "Killer (Serious)": {
        ...
        Stats: {
            Damage: [
                "142", "320", "533", "2267", "2967", "3702", "3991", "4143"
            ],
            Range: [
                "25", "25", "25", "28", "28", "28", "30", "30"
            ],
    ...
    "Mercury Guardian": {
        ...
        Stats: {
            Damage: [
                "735", "1305", "2040", "2900", "3020", "5320", "4575"
            ],
            Range: [
    ...
    "Shark Ninja": {
        ...
        Stats: {
            Damage: [
                "280", "420", "655", "1400", "1890", "2450", "5135", "6535"
            ],
            Range: [
    ...
    "Silent Swordsman": {
        ...
        Stats: {
            Damage: [
                "420", "875", "1365", "4495", "5915", "7450", "11975"
            ],
            Range: [
    ...
    "Spade": {
        ...
        Stats: {
            Damage: [
                "335", "540", "840", "1515", "2155", "2855", "3615", "2660"
            ],
            Range: [
    ...
    "Ziek (Beast Giant)": {
        ...
        Stats: {
            Damage: [
                "654", "1364", "2130", "2952", "3860", "9682", "13070", "17183"
            ],
            Range: [
